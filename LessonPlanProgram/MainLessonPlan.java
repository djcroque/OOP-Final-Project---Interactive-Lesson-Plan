...
public class MainLessonPlan {
    ...
    public static final String PLAN_DIR = /*(System.getProperty("user.dir"))*/ "C:\\Users\\Clark" + "\\Downloads\\" + "LessonPlanProgram\\lessonplan_data\\";
    ...
    public static void teacherView(int stInd){
        ...
        if (coors[stInd].teachers.isEmpty()){
        try {
            ...
            while((line = reader2.readLine()) != null){
                ...
                coors[stInd].teachers.add(teacher);
        }
            reader2.close();
        } catch (Exception e) {
            e.getStackTrace();
        ...
        for (int i = 0 ; i < coors[stInd].teachers.size(); i++){
            System.out.println("TEACHER " + (i+1));
            coors[stInd].teachers.get(i).showDetails();
        }
        ...
        System.out.println("\nChoose from the following:");
                    ...
                    choice = Integer.parseInt(input.nextLine());
                        ...
                        switch (choice){
                            case 1:
                                teachLoop = false;
                                addTeach(stInd, coors[stInd].teachers, filepath2);
                                break;
                            case 2:
                                teachLoop = false;
                                assignTeach(stInd, coors[stInd].teachers, filepath2);
                                break;
                            case 3:
                                teachLoop = false;
                                delTeach(stInd, coors[stInd].teachers, filepath2);
                                break;
                            case 4:
                                teachLoop = false;
                                coorMenu(stInd);
        ...
        do { 
            try {
                ...
                System.out.println("\nAssign Teacher under the " + strands[stInd] + " strand");
                    ...
                    teachers.get(choice1).showDetails();
        ...
        try {
            ...
            do { 
                try {
                    ...
                    lessonPlan.teacher.showDetails();
                    System.out.println("\tStrand: " + strands[stInd]);
                    System.out.println("""
                        1 - Yes
                        2 - No""");
                System.out.print("Enter your choice (1-2): ");
